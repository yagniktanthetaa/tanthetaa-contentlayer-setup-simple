...
export const GameCard = ({ content }) => {
  ...
  return (
    <>
      <div className="container grid gap-4 mx-auto transition-all duration-300 ease-in-out xl:grid-cols-2 mt-28 place-content-center place-items-center relative">
