...
const DevelopmentFractures = ({ content, path }) => {
            ...
            {content?.services?.map((item) => (
              <div key={item?.id}>
                {active === item?.id && (
                  <div
                    id="style-7"
                    className="bg-cover lg:h-96  p-4 lg:p-12  bg-center overflow-hidden overflow-y-scroll "
                    style={{
...
export default DevelopmentFractures;
